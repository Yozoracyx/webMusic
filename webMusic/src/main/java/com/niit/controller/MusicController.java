...
public class MusicController {
    ...
    @RequestMapping(value = "/getAllNewMusic", produces = "plain/text; charset=UTF-8")
    @ResponseBody
    public String getAllNewMusic(@RequestParam(required = false) Integer userId, HttpServletRequest request, HttpServletResponse response) {
        System.out.println("getAllNewMusic");
        String newMusic = musicService.getAllNewMusic();
        System.out.println(newMusic);
        return newMusic;
    }
