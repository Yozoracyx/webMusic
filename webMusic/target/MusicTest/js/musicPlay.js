...
$(document).on("click", ".like-div", function () {
    var likeNum = Number($(this).find("span").html());
...
function addMusicComment(comment) {
    ...
    for (var index = 0; index < comment.length; index++) {
        ...
        var cLikeNum = comment[index].cLikeNum;
        ...
        var commentDivLikeDiv = "<div class='like-div'>\n" +
            "<span>" + cLikeNum + "</span>" + 
            "            <div class='like-img'>\n" +
        ...
        var commentDivItem = commentDivItemHead + commentDivHead + commentDivHeadImg + commentDivTail + commentDivListHead +
            commentDivUName + commentDivCDate + commentDivContent + commentDivListTail + commentDivLikeDiv + commentDivItemTail;
